...
BACKPROPAGATION_BASE_TIMELINE = (
    ...
    TimelineSegment("partial_loss_meaning", 8.0, "formula_parts_focus", r"\partial L"),
    TimelineSegment("partial_prediction_meaning", 8.0, "formula_parts_focus", r"\partial \hat{y}"),
    TimelineSegment("derivative_ratio_meaning", 9.0, "formula_parts_focus", r"\frac{\partial L}{\partial \hat{y}}"),
    TimelineSegment("formula_output_delta", 11.0, "formula_parts_focus", r"\delta^{(2)}=\hat{y}-y"),
    TimelineSegment("hidden_weighted_return", 9.0, "formula_parts_focus", r"W_2^T\delta^{(2)}"),
    TimelineSegment("hidden_activation_gate", 9.0, "formula_parts_focus", r"\sigma'(z^{(1)})"),
    TimelineSegment("hidden_elementwise_product", 8.0, "formula_parts_focus", r"\odot"),
